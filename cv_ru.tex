...
\cvsection{Профиль}
\ifml{%
Python- и ML-разработчик, выпускник бакалавриата ВМК МГУ, студент магистратуры ВМК МГУ. Разрабатываю LLM-агентов и RAG-системы
...
Python-разработчик, выпускник бакалавриата ВМК МГУ, студент магистратуры ВМК МГУ. Разрабатываю бэкенд-сервисы на FastAPI в X5 Tech:
