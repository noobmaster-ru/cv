...
Middle ML-разработчик (Python, LLM, RAG)\par\vspace{3pt}
...
В X5 Tech разработал LLM-агента для проверки договоров: свыше 500 проверок на проде за четыре месяца,
