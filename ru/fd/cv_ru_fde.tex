...
Телефон: +7 (910) 968 1153 | Email: \href{mailto:kirillandreevickozlov@yandex.ru}{kirillandreevickozlov@yandex.ru} | Telegram: \href{https://t.me/noobmaster_rus}{@noobmaster\_rus}\par
...
\cvsection{О себе}
Инженер, который превращает бизнес-процессы в работающие ИИ-системы. С сентября 2026 в X5 Import (отдел
логистических решений) разрабатываю систему для 90\% иностранных поставок X5 Retail Group; до этого в департаменте
ИИ-агентов X5 Tech довёл до продакшена три задачи внутренних заказчиков: LLM-агент проверки договоров для юридического департамента (свыше 500 проверок
...
\cventry{AxiomAI (Telegram-бот на LLM)}{Октябрь 2025 --- Апрель 2026}{\href{https://github.com/noobmaster-ru/axiomai}{github.com/noobmaster-ru/axiomai}}
\begin{cvitems}
...
\end{cvitems}
\vspace{3pt}
\cventry{WB Parser}{Июль 2025 --- Сентябрь 2025}{\href{https://github.com/noobmaster-ru/tg-mini-app-backend}{github.com/noobmaster-ru/tg-mini-app-backend}}
\begin{cvitems}
