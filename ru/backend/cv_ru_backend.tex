...
Junior Python-разработчик (FastAPI, PostgreSQL, Kubernetes)\par\vspace{3pt}
...
X5 Retail Group; до этого в департаменте ИИ-агентов X5 Tech разработал три бэкенд-сервиса на FastAPI и развернул их в Kubernetes: LLM-агент для проверки
...
\cventry{Python-разработчик (Junior)}{Сентябрь 2026 --- настоящее время}{X5 Import, отдел логистических решений}
\begin{cvitems}
    \item Разрабатываю систему, обслуживающую 90\% иностранных поставок X5 Retail Group для её торговых сетей.
\end{cvitems}
\vspace{2pt}

\cventry{Python-разработчик (стажёр)}{Апрель 2026 --- Август 2026}{X5 Tech, департамент ИИ-агентов, Москва}
\begin{cvitems}
%
